...
async function updateCompaniesFromExcel() {
  const inputJsonPath = path.join(__dirname, "../Jsons/etfBdr.json");
  const outputJsonPath = path.join(__dirname, "../Finais/etfBdr.json");
  let empresasData;
  ...
  try {
    ...
    const spreadsheetId = "1bmpDmXbQQ_uBOYZUZfoL4GeilyZzcO_MkiFutcoyunA";
